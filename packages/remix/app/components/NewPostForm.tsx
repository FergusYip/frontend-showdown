    ...
    <div className="w-full rounded-md border p-4 shadow-md">
      <Form method="post">
        ...
        <div className="flex justify-end mt-2 space-x-2">
          ...
          <button
            className="text-base py-2 px-6 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-indigo-200 "
            type="submit"
          >
            Post
          </button>
